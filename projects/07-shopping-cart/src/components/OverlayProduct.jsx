...
export function OverlayProduct({productSelect, handleShowMore, isProductInCart}) {
    ...
    return(
        ...
        `}>
            <div className={`flex border items-stretch px-8 pr-[5em] 2xl:px-10 2xl:pr-[7em] py-10 gap-10 2xl:gap-20 max-w-screen-xl min-h-[60vh] h-fit w-fit rounded-md relative
                ...
                `}>
                <span onClick={handleShowMore} className={`cross-exit ${theme===Theme.LIGHT?'after:bg-darked before:bg-darked':'after:bg-white before:bg-white hover:after:bg-slate-300 hover:before:bg-slate-300'} absolute top-6 right-7`}></span>
                ...
                <article className="h-full flex flex-col gap-4">
                    ...
                    <div className='mt-4 flex flex-col gap-3'>
                        <CartButton product={productSelect} isProductInCart={isProductInCart}/>
                    </div>
                </article>
            </div>
        </section>
